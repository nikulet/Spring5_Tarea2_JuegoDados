package S05T2CebanNicusor.JuegoDados.config;

import S05T2CebanNicusor.JuegoDados.model.service.impl.PlayerServiceMySQLImpl;
import S05T2CebanNicusor.JuegoDados.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    private RequestMatcher userEndpoints(){
        return new OrRequestMatcher(
                ...
                new AntPathRequestMatcher("/players/**", HttpMethod.PUT.toString())
        );
    }
}
